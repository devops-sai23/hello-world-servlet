...
// for display purposes
     ...
     git 'https://github.com/devops-sai23/hello-world-servlet.git'
      // Get the Maven tool.
...
post {
        success {
            mail to:"devops.sai23@gmail.com", subject:"SUCCESS: ${currentBuild.fullDisplayName}", body: "Build success"
        }
        failure {
            mail to:"devops.sai23@gmail.com", subject:"FAILURE: ${currentBuild.fullDisplayName}", body: "Build failed"
        }
    }       
}
